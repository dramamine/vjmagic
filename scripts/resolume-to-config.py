...
tree = ET.parse('C:/Users/marten/Dropbox/Resolume Arena 5/compositions/feb 2017 trials.avc')
...
for clip in clips:
    ...
    settings = clip.find("settings/name[@value='Effect Clip']..")
    if settings is not None:
        ...
        print [key, 'KNOBS', clip_name, param_names]
